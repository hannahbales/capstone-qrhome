/*
  ...
  - You are about to drop the column `id` on the `TwoFactorCode` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "TwoFactorCode" DROP CONSTRAINT "TwoFactorCode_pkey",
DROP COLUMN "id",
ADD CONSTRAINT "TwoFactorCode_pkey" PRIMARY KEY ("userId");
